...
public class vehicleManager : EditorWindow{
    ...
    void checkComponents(){
        ...
        if(FindAnyObjectByType<Camera>() != null){
            ...
            if(FindAnyObjectByType<Camera>().GetComponent<cameraController>() == null){
                camController = FindAnyObjectByType<Camera>().gameObject.AddComponent<cameraController>();
                ...
                camController = FindAnyObjectByType<Camera>().gameObject.GetComponent<cameraController>();
                    camController.cameraPos = new Vector2[3];
                    camController.cameraPos[0] = new Vector2(2,0);
                    camController.cameraPos[1] = new Vector2(7.5f,0.5f);
                    camController.cameraPos[2] = new Vector2(8.4f,1.6f);
